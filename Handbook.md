...
> While we're here in a box, I want to address something; there are no rules for items or equipment in this game. As an Arbiter, you are free to make up magical or technological items where it suits your game. In general, basic equipment is not tracked in this game. Axes and swords don't have different stats. In general, a character should start with their most essential items (weapons, armor, tools) assumed to be part of their kit. The basic idea is that character in SSS are distinguished by what they can do, not what kind of gear they have. If you're playing a character with high strength, they can start with appropriate weapons. If your character is a mage, they can start with any implements they need to use their magic. If you're playing a very sturdy character, if appropriate they could start with armor.
