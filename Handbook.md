...
//Summoning will come after basic playtesting. For now I want to test base mechanics, and I 
//think summoning gets to be its own thing.
...
* Increase the target’s Physical or Mental Defense by your Hero Tier.
...
You have an air of danger to you that can distract foes from others who would deceive them, making them easier to read. You grant allies Boon 2 on Empathy checks outside of combat.[z]
...
Special: None
//A bit simple. Maybe add another effect? A heal?
Description: You improve the power of your future attacks. This could represent taking time to wind up a punch, analysing a foe to find their weak point, biting one’s tongue to build a berserker rage, and similar actions.
...
//Another simple one, but maybe these are efficient enough to overcome that?
...
Optional Rules - Complicating Factors During a Chase
...
[a]Another alternative "power stat" progression scheme I've seen is to have it increase automatically whenever a player has spent some specified amount of XP.
[b]That's a possibility I will consider. I could see that working better if players find buying levels separately to be a downer. I'm trying to let people control whether they go deep or broad with this system, and your suggestion sets the ratio somewhere in the middle. That might not be a bad thing, but I want to see how people feel about the current setup.
[c]I would suggest testing it for certain player types: How could a min-maxer abuse the system? How lost could a indifferent person become and get themselves into the position of a half-baked character? Too much freedom can become a problem.
[d]Powers and abilities are often used interchangeably in RPG terminology, so I see people mixing these two up if they have separate game meanings.
[e]Yeah, that's very true. I'm not sure what to call these and I'm not married to "Powers." If you have suggestions please let me know.
[f]"Talents"? That would emphasise the passive nature of them, as you are never are being talented actively. You simply happen to have talents.
[g]Utility is a fine piece of terminology in general, but specifically "utilities", plural, sounds more like something you pay bills for than something you spend XP on
[h]I'm not sure what you're getting at here? There's no alternative if the name stays "Utility" when I am talking about more than one of them.
[i]Depending on the strength of higher tier Stances this might be something to keep an eye on balance-wise.
[j]Having a power that sort of defines an archetype locked behind a prerequisite so that you can't get it at character creation may discourage players from pursuing that build in play (even if nothing stops you from just using spells with the base enrage power anyway)
[k]I'm looking at this Power for a rework. Increasing multipliers is *extremely* powerful and I'm not sure currently where this lies. I'm keeping it as is for now in case someone's interested in playtesting the concept.
[l]This might become a little wonky. Can't double bane 6 at the highest tiers easily make an attack hit you much harder?
[m]Note that I'm starting here as this is the area in which I have the most knowledge so far. I'll backtrack to make comments on Finesse and Strong abilities after this and may jump around a bit more.
[n]Perhaps "Regenerator" or something along those lines. I think it needs to be flavored to stand out from Hulk at a glance here as well.
[o]"Bounceback"? Resolute implies not caring about risks and would thus be closer to the Berzerker.
[p]Be sure to include "stack" in your glossary of key mechanics terms, once you get round to writing that. I had to jump around through the book a bit to figure out what exactly you meant here. I might even capitalize Stack to remind readers that it's a mechanic.
[q]If you do the math, isn't rather useless unless you have absourd Toughness/Strength values? For 3 exp you get much more HP if you just buy those directly.
[r]+ X% HP perhaps? Too strong because scaling?
[s]I'm not going to add any percentages because I want the integers used to stay manageable. As soon as fractions other than halves gets involved it becomes too cumbersome to do quickly at the table.


As far as doing the math, maybe back before I decreased the Power cost and scaling? I feel like this *should* be useful as-is; it relieves pressure to take level ups (since Vitality is limited by your level) and makes that XP spent to get Vitality levels go further. That said, I haven't actually done the math yet. One more thing on the pile I suppose.
[t]Toughness? If so, my instinct says this should maybe be a +1 instead. But I could easily be wrong and I think it just needs some testing.
[u]Are you envisioning this system as one that makes use of the "Scene" style of storytelling? If so, once per Scene might streamline this nicely.
[v]With the new ability buy method, this becomes incredibly useful for melee tanks. Not a problem, necessarily, but maybe worth testing.
[w]Remind me to do some math sometime to figure out what impact this actually has
[x]Yeah, we should do that together sometime. I'm really wary about it, but it seems thematically appropriate.
[y]This is already the name of a Geomancer ability.
[z]Come back to this
[aa]What about flying combatants? Can those be attacked by melee attacks?