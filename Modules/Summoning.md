...
If an Ally runs out of HP, you cannot use Summon with the same Summon Configuration for ten minutes. If you have multiple Summon Configuration options, you may choose to summon a different one after another has been knocked out by using this Ability again.  
...
Targets: 1 ally  
Summoner MP Cost: 2  
The Support Ally heals the target for an amount equal to its Efficacy. This can be done for free once per turn, but cannot be used on the same turn as Jolt.  
...
Range: Medium  
Targets: 1 ally  
Summoner MP Cost: 4 MP  
The Support Ally heals the target an amount equal to twice its Efficacy. This Ability cannot be used in the same Round as Jolt or Soothe.   
...
### Potent Healer  
Increase your Ally's Efficacy by 1.  
...
## Intense Summon  
When you use [Summon](#summon), you may choose to double the MP cost and Upkeep to gain the following benefits:  
* Increase your Ally's HP by 50%.  
* Automatically added one [Advanced Option] to your Ally based on its Configuration:  
  * Attacker and Spellcaster Allies gain [Offense Up](#offense-up)  
  * Defender Allies gain [Defense Up](#defense-up)
  * Support Allies gain [Potent Healer](#potent-healer)  
* Add an additional [Advanced Option](#advanced-options) to your Ally. This is in addition to the one automatically added. You may choose any Advanced Option normally available to the Summon Configuration you are summoning.  
* Your Ally may use its Empowered Abilities without using your Minor Action.  
If you also have the [Double Summon](#double-summon) Talent, you can only use Intense Summon on one of your Allies.  
